...
class Calculator2:
    ...
    def calculate(self, request: FlaskRequest) -> Dict: #type: ignore
        ...
        calculated_number = self.__first_data(input_data)
    ...
    def __first_data(self, input_data: List[float]) -> float:
        first_process_result = [(num * 11) ** 0.95 for num in input_data]
        result = self.__driver_handler.standard_derivations(first_process_result)
        return 1/result
